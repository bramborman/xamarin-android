...
namespace Xamarin.Android.Tasks
{
	partial class GenerateLayoutBindings
	{
		sealed class CSharpBindingGenerator : BindingGenerator
		{
			...
			{
				// TODO: Add tool and version
				WriteLineIndent (state, $"[global::System.CodeDom.Compiler.GeneratedCode(tool: null, version: null)]");
			...
			{
				WriteComment (state, " <auto-generated />");
				WriteLineIndent (state, "#nullable disable");
			...
			void WritePreserveAtribute (State state, bool linkerPreserve)
			{
				...
				WriteLine (state, "#if NET6_0_OR_GREATER");
				// TODO: Use DynamicDependencyAttribute??
				////WriteLineIndent (state, $"[global::Android.Runtime.PreserveAttribute (Conditional=true)]");
				WriteLine (state, "#else");
				WriteLine Indent (state, $"[global::Android.Runtime.PreserveAttribute (Conditional=true)]");
				WriteLine (state, "#endif");
			}
